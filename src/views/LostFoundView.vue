  ...
  <div>
    ...
    <div class="card mb-16">
      <div class="flex flex-center gap-16">
        <div class="search-box">
          ...
          <input v-model="search" placeholder="搜索失物名称..." class="search-input" />
        </div>
        ...
        <router-link to="/publish" class="btn btn-primary" style="margin-left:auto">发布信息</router-link>
      </div>
    </div>
    ...
    <div v-else class="grid-3">
      <div v-for="item in list" :key="item.id" class="card card-hover">
        <div class="lost-header flex flex-center gap-8">
